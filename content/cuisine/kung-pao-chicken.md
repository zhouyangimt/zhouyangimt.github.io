...
I spent fifteen years writing code at Microsoft, Google, and NVIDIA before I quit to chase the 25th frame — the thing between the frames that makes them move. Kung Pao Chicken works the same way. The components are simple. The space *between* them does the work.
