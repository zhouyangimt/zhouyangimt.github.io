(function(){
  ...
  function search(query) {
    ...
    if (results.length === 0) {
      ...
      for (var k = 0; k < results.length; k++) {
        ...
        html += '<div class="search-result" data-url="' + r.page.url + '">';
  ...
  // Handle clicks on search results (explicit delegation)
  ...
  input.addEventListener('keydown', function(e){
    ...
    if (e.key === 'ArrowDown') {
      ...
      e.preventDefault();
      var url = items[selected].dataset.url;
  ...
  // Click on input shows results if query present
